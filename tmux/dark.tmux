...
set -g status-right '#[fg=colour233,bg=colour4] %d/%m #[fg=colour233,bg=colour10] Local %H:%M | Surya: #(TZ="Asia/Kolkata" date +%%H:%%M) | Eirik: #(TZ="Asia/Bangkok" date +%%H:%%M) #[fg=colour239]'
