...
set -g status-right '#[fg=colour4]#[fg=colour233,bg=colour4] %d/%m/%Y #[fg=colour10]#[fg=colour233,bg=colour10] Local %H:%M | Eirik: #(TZ="Asia/Bangkok" date +%%H:%%M) | Surya: #(TZ="Asia/Kolkata" date +%%H:%%M) '
